...
def edit_artist_submission(artist_id):
  # TODO: take values from the form submitted, and update existing
    ...
    try:
        ...
        flash("Artist: " + request.form['name'] + " has been successfully listed")
...
def edit_venue_submission(venue_id):
  ...
  # venue record with ID <venue_id> using the new attributes
    ...
    try:
        ...
        flash("Venue: " + venue.request['name'] + " has been successfully updated!")
    
    except Exception as e:
        db.session.rollback()
        print(e)
        flash("An error occured Venue " + venue.request['name'] + " could not be updated!")
    finally:
        db.session.close()
