...
def show_venue(venue_id):
  ...
  # TODO: replace with real venue data from the venues table, using venue_id
    ...
    data = {
        ...
        "genres": [real_venue.genres],
        "address": real_venue.address,
        "city": real_venue.city,
        "state": real_venue.state,
        "phone": real_venue.phone,
        "website_link": real_venue.website_link,
...
def show_artist(artist_id):
  ...
  # TODO: replace with real artist data from the artist table, using artist_id
    ...
    if artist_data is None:
        ...
        flash("This artist is not available.")
        return render_template('errors/404.html')
    ...
    for fetch_show in (
        ...
        upcoming_shows.append(
            {
                "venue_id": fetch_show.venue_id,
                "venue_name": fetch_show.venue.name,
                "venue_image_link": fetch_show.venue.image_link,
                "start_time": str(fetch_show.start_time) 
            }
        )
